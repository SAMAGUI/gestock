        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#parametre" aria-expanded="false"
                            aria-controls="auth">
                        ...
                        <div class="collapse" id="parametre">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ asset('/annees') }}"> Année Scolaire </a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href=""> Cabine </a>
                                </li>
                            </ul>
                        </div>
                    </li>
